...
public class GoopFluid extends FlowableFluid {

    public Fluid getFlowing() {
        return ModFluids.GOOP_FLOWING;
    }

    public Fluid getStill() {
        return ModFluids.GOOP_STILL;
    }

    public Item getBucketItem() {
        return ModItems.GOOP_BUCKET;
    }
    ...
    public BlockState toBlockState(FluidState state) {
        return (BlockState)ModBlocks.GOOP_FLUID_BLOCK.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }
    ...
    public boolean matchesType(Fluid fluid) {
        return fluid == ModFluids.GOOP_STILL || fluid == ModFluids.GOOP_FLOWING;
    }
    ...
    public static class Flowing extends GoopFluid {
        public Flowing() {
        }
    ...
    public static class Still extends GoopFluid {
        public Still() {
        }
