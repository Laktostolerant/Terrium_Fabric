...
public class VoidFishModel<T extends VoidFishEntity> extends SinglePartEntityModel<T> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData leftFin = body.addChild("leftFin", ModelPartBuilder.create().uv(24, 4).cuboid(0.0F, 0.0F, 0.0F, 2.0F, 1.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(1.0F, -1.0F, 0.0F, 0.0F, 0.0F, 0.6109F));

        ModelPartData rightFin = body.addChild("rightFin", ModelPartBuilder.create().uv(24, 1).cuboid(-2.0F, 0.0F, 0.0F, 2.0F, 1.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(-1.0F, -1.0F, 0.0F, 0.0F, 0.0F, -0.6109F));

        ModelPartData tailfin = body.addChild("tailfin", ModelPartBuilder.create().uv(20, 1).cuboid(0.0F, -4.0F, 0.0F, 0.0F, 4.0F, 6.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 8.0F));
